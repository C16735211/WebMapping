...
SECRET_KEY = 'rf_!(^%$u@j&pfou*zcz+n+t@yg0y$gq!083_u-um2@-i2j2e0'
...
PWA_APP_ICONS = [
    {
        'src': 'templates/my_app_icon.png',
        'sizes': '100x100'
    }
]

PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, 'geodjango', 'serviceworker.js')
